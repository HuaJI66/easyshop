...
import static com.unionpay.acp.sdk.SDKUtil.*;
...
public class GmAcpService {
	...
	private final static Logger logger = LoggerFactory.getLogger(GmAcpService.class);
	...
	public static Map<String, String> sign(Map<String, String> reqData, String encoding) {
		Map<String, String> data = filterBlank(reqData);
		...
		if (isEmpty(signMethod)) {
			logger.error("signMethod is empty");
			return data;
		}

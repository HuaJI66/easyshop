...
public class GmAcp6Service {
	...
	private final static Logger logger = LoggerFactory.getLogger(GmAcp6Service.class);
	...
	public static Map<String, String> sign(Map<String, String> reqData,String encoding) {
        return signByCertInfo(reqData,
        		GmUnionPayAutoConfiguration.getConfig().getSignCertPath(),
        		GmUnionPayAutoConfiguration.getConfig().getSignCertPwd(),
        		encoding);
	}
	...
	public static Map<String, String> signByCertInfo(Map<String, String> reqData, String certPath,
        ...
        Map<String, String> data = com.unionpay.acp.sdk.SDKUtil.filterBlank(reqData);

        if (com.unionpay.acp.sdk.SDKUtil.isEmpty(encoding)) {
            encoding = "UTF-8";
        }

        if (com.unionpay.acp.sdk.SDKUtil.isEmpty(certPath) || com.unionpay.acp.sdk.SDKUtil.isEmpty(certPwd)) {
	...
	public static String encryptPin(String accNo, String pin, String encoding) {
		byte[] pinblock = com.unionpay.acp.sdk.SecureUtil.pinblock(accNo, pin); //pinblock算法确认过和国际一致

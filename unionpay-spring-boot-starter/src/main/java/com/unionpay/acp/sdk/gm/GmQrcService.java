...
import com.unionpay.acp.sdk.QrcService;
...
public class GmQrcService {
	...
	private final static Logger logger = LoggerFactory.getLogger(GmQrcService.class);
	...
	public static Map<String, String> sign(Map<String, String> reqData,String encoding) {
        return signByCertInfo(reqData, GmUnionPayAutoConfiguration.getConfig().getSignCertPath(), GmUnionPayAutoConfiguration.getConfig().getSignCertPwd(), encoding);
	}

...
public class DemoBase {
	...
	//全渠道固定值
	public static String version = UnionPayAutoConfiguration.getConfig().getVersion();

	//后台服务对应的写法参照 FrontRcvResponse.java
	public static String frontUrl = UnionPayAutoConfiguration.getConfig().getFrontUrl();

	//后台服务对应的写法参照 BackRcvResponse.java
	public static String backUrl = UnionPayAutoConfiguration.getConfig().getBackUrl();//受理方和发卡方自选填写的域[O]--后台通知地址
